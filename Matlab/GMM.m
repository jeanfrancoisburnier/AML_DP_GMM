...
N_points_class_1 = 50000;
N_points_class_2 = 500;
...
% Plot decision boundary
figure
xplot = linspace(min(X(1,:))-20, max(X(1,:))+20, 1000)';
yplot = linspace(min(X(2,:))-3, max(X(2,:))+3, 1000)';
